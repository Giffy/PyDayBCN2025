...
from typing import Annotated, NotRequired, Sequence, Dict, Any
...
@tool 
def get_invoices_sorted_by_unit_price(runtime: ToolRuntime) -> str | Sequence[Dict[str, Any]]:
    """
    ...
    """
    customer_id = runtime.state.get("customer_id", "Unknown user")
    query = f"""
